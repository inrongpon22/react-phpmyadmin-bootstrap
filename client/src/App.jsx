...
function App() {
  ...
  const updateEmployeeWage = (id) => {
    Axios.put("http://localhost:3001/update", {wage: newWage, id: id}).then((res) => {
      setEmployeeList(
    ...
    <div className="App ms-5">
      ...
      <div className="employee">
        ...
        {employeeList.map((val, key) => {
          return (
            <div key={key} className='employee card my-3'>
              <div className="card-body text-left">
                ...
                <div className="d-flex">
                  ...
                  <button className='btn btn-danger' onClick={() => {deleteEmployeeWage(val.id)}}>Update</button>
                </div>
              </div>
            </div>
          )
